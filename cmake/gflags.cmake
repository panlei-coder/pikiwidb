...
#   set(DEPENDENCY_LIB_PATH ${CMAKE_CURRENT_BINARY_DIR}/_deps/gflags-build/libgflags_debug.a)
#   add_custom_command(
#     OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/_deps/gflags-build/libgflags.a
#     COMMAND ${CMAKE_COMMAND} -E create_symlink${DEPENDENCY_LIB_PATH} ${CMAKE_CURRENT_BINARY_DIR}/_deps/gflags-build/libgflags.a
#     COMMENT "Creating symbolic link to dependency library"
#   )

#   add_custom_target(gflags DEPENDS ${CMAKE_CURRENT_BINARY_DIR}/_deps/gflags-build/libgflags.a)
# ENDIF ()
