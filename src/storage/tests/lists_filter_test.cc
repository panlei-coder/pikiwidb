...
TEST_F(ListsFilterTest, DataFilterTest) {
  ...
  storage::EncodeFixed64(str, 1);
  ListsMetaValue lists_meta_value1(rocksdb::Slice(str, sizeof(uint64_t)));
  ...
  storage::EncodeFixed64(str, 1);
  ListsMetaValue lists_meta_value2(rocksdb::Slice(str, sizeof(uint64_t)));
  ...
  storage::EncodeFixed64(str, 1);
  ListsMetaValue lists_meta_value3(rocksdb::Slice(str, sizeof(uint64_t)));
  ...
  storage::EncodeFixed64(str, 1);
  ListsMetaValue lists_meta_value4(rocksdb::Slice(str, sizeof(uint64_t)));
  ...
  storage::EncodeFixed64(str, 1);
  ListsMetaValue lists_meta_value5(rocksdb::Slice(str, sizeof(uint64_t)));
  ...
  // Insert a zset key
  storage::EncodeFixed32(buf, 1);
  ZSetsMetaValue zsets_meta_value(DataType::kZSets, rocksdb::Slice(buf, 4));
  ...
  // Insert a list key
  storage::EncodeFixed64(str, 1);
  ListsMetaValue lists_meta_value(rocksdb::Slice(str, sizeof(uint64_t)));
  ...
  storage::EncodeFixed32(buf, 1);
  SetsMetaValue sets_meta_value(DataType::kSets, rocksdb::Slice(str, 4));
  ...
  filter_result =
      lists_data_filter->Filter(0, lists_data_key.Encode(), "FILTER_TEST_VALUE", &new_value, &value_changed);
  ASSERT_EQ(filter_result, true);
  s = meta_db->Delete(rocksdb::WriteOptions(), handles[0], "FILTER_TEST_KEY");
  ASSERT_TRUE(s.ok());
  ...
  // Insert a hash key
  storage::EncodeFixed32(buf, 1);
  HashesMetaValue hash_meta_value(DataType::kHashes, rocksdb::Slice(buf, 4));
  ...
  storage::EncodeFixed64(str, 1);
  ListsMetaValue lists_meta_value6(rocksdb::Slice(str, sizeof(uint64_t)));
