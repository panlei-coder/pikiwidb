...
TEST(ZSetScoreKeyComparator, FindShortestSeparatorTest) {
  ...
  impl.FindShortestSeparator(&change_start_1, rocksdb::Slice(limit_1));
  ...
  impl.FindShortestSeparator(&change_start_2, rocksdb::Slice(limit_2));
  ...
  impl.FindShortestSeparator(&change_start_3, rocksdb::Slice(limit_3));
  ...
  impl.FindShortestSeparator(&change_start_4, rocksdb::Slice(limit_4));
  ...
  impl.FindShortestSeparator(&change_start_5, rocksdb::Slice(limit_5));
  ...
  impl.FindShortestSeparator(&change_start_6, rocksdb::Slice(limit_6));
  ...
  impl.FindShortestSeparator(&change_start_7, rocksdb::Slice(limit_7));
  ...
  impl.FindShortestSeparator(&change_start_8, rocksdb::Slice(limit_8));
  ...
  impl.FindShortestSeparator(&change_start_9, rocksdb::Slice(limit_9));
