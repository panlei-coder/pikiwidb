...
static bool key_value_match(const std::vector<storage::KeyValue>& key_value_out,
  ...
  for (int32_t idx = 0; idx < key_value_out.size(); ++idx) {
    WARN("key_value_out[idx]: {} expect_key_value[idx]: {}", key_value_out[idx].key, expect_key_value[idx].key);
...
TEST_F(KeysTest, PKScanRangeTest) {  // NOLINT
  ...
  //=============================== Sets ===============================
  std::vector<storage::KeyValue> kvset{{"PKSCANRANGE_A1", "VALUE"}, {"PKSCANRANGE_C1", "VALUE"},
                                       {"PKSCANRANGE_E1", "VALUE"}, {"PKSCANRANGE_G1", "VALUE"},
  ...
  //=============================== Hashes ===============================
  std::vector<storage::KeyValue> kvhash{{"PKSCANRANGE_A2", "VALUE"}, {"PKSCANRANGE_C2", "VALUE"},
                                        {"PKSCANRANGE_E2", "VALUE"}, {"PKSCANRANGE_G2", "VALUE"},
  ...
  std::vector<storage::KeyValue> kvzset{{"PKSCANRANGE_A3", "VALUE"}, {"PKSCANRANGE_C3", "VALUE"},
                                        {"PKSCANRANGE_E3", "VALUE"}, {"PKSCANRANGE_G3", "VALUE"},
  ...
  //=============================== Lists  ===============================
  std::vector<storage::KeyValue> kvlist{{"PKSCANRANGE_A4", "VALUE"}, {"PKSCANRANGE_C4", "VALUE"},
                                        {"PKSCANRANGE_E4", "VALUE"}, {"PKSCANRANGE_G4", "VALUE"},
